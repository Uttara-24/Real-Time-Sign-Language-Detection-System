...
const HeroSection = () => {
    ...
    const onButtonClick = async (gestureDataPath) => {
    ...
    return (
      <div className="HeroSection">
        ...
        <div id="box2">
            ...
            <button id="getStarted" onClick={()=> handleClick('E:/Placement/Research Paper/Sign Language Detection System/my_flask_app/backend/gestures/0')}> Get started </button>
